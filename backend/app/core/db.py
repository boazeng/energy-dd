...
# (account_number, opening_balance, debit, credit, balance)
_LEDGER_DATA: list[tuple[str, float, float, float, float]] = [
    ...
    ("186",     69.62,  348.10,    417.72,          0.00),
    ("188",      0.00,   0.00,   1393.72,      -1393.72),
    ("252",   -784.70, 15885.00, 20246.70,      -4361.70),
    ("255",      0.00,   0.00,   1933.34,      -1933.34),
    ("257",  29780.64,  9920.68, 46875.18,      -7173.86),
    ("360",  28143.80,   0.00,  40209.80,     -12066.00),
    ...
    ("472",  38878.41,   0.00,  60323.84,     -21445.43),
