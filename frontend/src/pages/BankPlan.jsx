...
הפעילות מבוססת על התקשרויות חוזיות ארוכות טווח מול ועדי בתים, חברות ניהול ויזמים, לצד הסכמי שימוש מול משתמשי הקצה. מבנה זה יוצר בסיס הכנסות חוזר ויציב, המתרחב בהדרגה ככל שמצטרפים דיירים נוספים באותם בניינים — ללא צורך בהתקשרות חדשה ובהשקעת תשתית נוספת.`,
  ...
  '1.2a': `האשראי המבוקש נדרש למימון רכישת פעילותה של חברת שאר מוביליטי בע"מ (להלן: "החברה הנרכשת") והטמעתה כפעילות מקבילה, לצד פעילותה של חברת אנרגיה ירוקה מקבוצה אורבנית.`,
...
- ההכנסה ממכירת מטעני DC — מטענים מהירים במרכזים המסחריים, הנכללת בתחזית שלהלן.
      ...
      <article className="bkp-sheet" dir="rtl">
        ...
        <section className="bkp-section bkp-level-1">
          ...
          <p className="bkp-p">
            ...
            כפעילות מקבילה לצד פעילותה של חברת אנרגיה ירוקה מקבוצה אורבנית, והרחבת הפעילות
            לתחומים נוספים כגון מטעני DC מהירים.
          </p>
          <p className="bkp-p">
